...
#get all games
def get_all_games(season,roster,table):
    result = 0    
    ...
    #stats
    with open('stats_to_get.lst') as f:
        stats = f.readlines()

    #iterate over teams
    for team in teams:
        url = make_query(players,team.rstrip(),stats)
...
if __name__ == '__main__':
    ...
    print get_all_games(seasonId,roster,table)
